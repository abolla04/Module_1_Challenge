...
print(f"The total of the loans is: {total_loan_value}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
average_loan_price = total_loan_value/number_of_loans
print(f"The average loan price is: {int(average_loan_price)}")
